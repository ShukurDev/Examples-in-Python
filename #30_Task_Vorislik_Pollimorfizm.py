...
class Xona:
    def __init__(self,hudud,nomi,nomeri,ysoni):
       self.hudud=hudud
       self.nomi=nomi
       self.nomeri=nomeri
       self.ysoni=ysoni
       self.manzillar=[]
    def get_manzil(self,manzil):
       self.manzil=manzil
       self.manzillar.append(manzil)
       self.ms+=1
       return f"Manzil : {self.manzil}.\n"
    def get_muassasa(self,nom):
      self.nom = nom
      return f"Muassasa nomi : {self.nom}.\n"
xona1=Xona("Urganch","TATU UF",311,3)
print(xona1.get_manzil("TATU"))
